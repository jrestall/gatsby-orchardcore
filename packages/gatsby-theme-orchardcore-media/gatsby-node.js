...
const MediaBuilder = require('./src/MediaBuilder').default

/**
 * Register the LayerBuilder so that it can help build GatsbyJS pages.
 */
registerBuilder(MediaBuilder)
...
exports.onCreateWebpackConfig = ({ stage, loaders, plugins, actions }) => {
  const debug = Debug('gatsby-theme-orchardcore-media:onCreateWebpackConfig')
      ...
      rules: [
        {
          ...
          include: path.dirname(
            require.resolve('gatsby-theme-orchardcore-media')
          ),
          use: [loaders.js()],
        },
      ],
